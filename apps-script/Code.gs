...
var DEFAULT_COMMITTEE_SKILLS = {
  ...
  'ملف التفعيل': ['تفعيل عضوية المتقدمين', 'إدارة حسابات الأعضاء', 'التوثيق والمتابعة', 'الخدمات الرقمية', 'الدعم أثناء التفعيل'],
  'ملف التوسع': ['التوسع في الجامعات', 'بناء الفروع', 'زيادة الانتشار', 'إدارة النمو', 'التواصل مع الكيانات الجديدة'],
  'منسقي القطاعات': ['التنسيق بين القطاعات', 'متابعة الأداء', 'التقارير القطاعية', 'إدارة الفعاليات القطاعية', 'التواصل الميداني']
};
