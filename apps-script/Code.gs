...
var DEFAULT_COMMITTEE_SKILLS = {
  'ال Media': ['التصوير الفوتوغرافي', 'المونتاج', 'التصميم الجرافيكي', 'إدارة صفحات التواصل', 'البث المباشر'],
  'ال Pisas': ['التنسيق والمتابعة', 'إدارة الملفات', 'التواصل الداخلي', 'تخطيط الاجتماعات', 'إعداد التقارير'],
  'ال Event': ['تخطيط الفعاليات', 'تنسيق المواقع', 'إدارة الوقت', 'تحليل المخاطر', 'التقييم والمتابعة'],
  'ال Human Resources': ['التوظيف', 'التطوير الوظيفي', 'إدارة الأداء', 'حل النزاعات', 'بناء الفرق'],
  'ال Training': ['تصميم البرامج التدريبية', 'التفويض', 'التقييم', 'المحاضرة الفعالة', 'التدريب عن بُعد'],
  'ال Marketing': ['التسويق الرقمي', ' كتابة المحتوى', 'تحليل السوق', 'إدارة الحملات', 'العلامة التجارية'],
  'ال Relations': ['العلاقات العامة', 'التواصل مع الجهات外部', 'بناء الشراكات', 'إدارة الملفات الرسمية', 'التواصل الكتابي'],
  'ال Creative': ['التصميم الإبداعي', 'Brainstorming', 'حل المشكلات الإبداعي', 'التفكير خارج الصندوق', 'إدارة المشاريع الإبداعية']
};
